...
const texts = ["you have no idea what youre talking about"]
const typingSpeed = 0;
...
document.addEventListener('DOMContentLoaded', () => {
    const imgSrc = "https://lanyard.cnrad.dev/api/974792938624262184?bg=00000000&animated=true=true&hideSpotify=false&showDisplayName=true&hideActivity=true";
