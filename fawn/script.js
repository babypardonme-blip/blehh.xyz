...
const texts = ["from dust we grow to dust return"]
const typingSpeed = 0;
...
document.addEventListener('DOMContentLoaded', () => {
    const imgSrc = "https://lanyard.cnrad.dev/api/860976898631532564?bg=00000000&animated=true=true&hideSpotify=false&showDisplayName=true&hideActivity=true";
